...
select public.seed_catalog_variants(
  ...
  array['comun','holo'],
  array[]::text[],
  array['Patrones','Rojo','Amarillo','Plateado','Verde','Azul','Violeta','Turquesa']
);
...
select public.seed_catalog_variants(
  ...
  array['Rojo','Azul','Verde','Amarillo','Turquesa','Violeta']
);
...
select public.seed_catalog_variants(
  ...
  array['Verde','Violeta','Celeste','Rojo']
);
...
select public.seed_catalog_variants(
  ...
  array['fluor','holo'],
  array['Amarillo','Naranja','Verde','Rosa'],
  array['Verde','Violeta','Celeste','Rojo','Plateado','Azul','Patrones']
);
