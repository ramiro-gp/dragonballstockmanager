...
export function SubscriptionExpiredPage({ sellerWhatsapp }: { sellerWhatsapp: string }) {
  const text = encodeURIComponent("Hola rama te envío comprobante de pago. Renové la suscripción por un mes más.");
  const plans = [
    { label: "1 mes", price: "$2500" },
    { label: "3 meses", price: "$6500" },
    { label: "6 meses", price: "$11500" },
