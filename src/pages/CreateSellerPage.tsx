...
import { isValidArgentinaWhatsapp, whatsappHint } from "../lib/whatsapp";
  ...
  return (
    <section className="tool-surface">
      ...
      <p className="mt-2 text-sm text-[var(--muted)]">
        El estado se activa automaticamente al crearlo. Si elegis meses, la fecha de vencimiento se calcula desde hoy; si elegis pago unico, queda sin vencimiento.
      </p>
      <div className="mt-4 grid gap-3 md:grid-cols-2">
        <label className="field"><span>Nombre visible</span><input maxLength={60} placeholder="Nombre del vendedor" /></label>
        <label className="field"><span>Slug publico</span><input maxLength={32} placeholder="nombre-vendedor" /></label>
      ...
      <button className="primary-button mt-4" disabled={!isValidArgentinaWhatsapp(whatsapp)}>Crear vendedor</button>
    </section>
  );
}
